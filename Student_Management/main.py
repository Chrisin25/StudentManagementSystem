...
stop=False
while not stop:
    choice = int(input(print("Enter your choice:1.add student 2.remove student 3.search student 4.generate student.")))
    if choice==1:
        new_school.add_student()
    elif choice==2:
        student_id = int(input(print("enter student id:")))
